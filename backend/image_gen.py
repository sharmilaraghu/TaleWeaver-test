...
async def _is_safe_for_children(content: str) -> bool:
    ...
    prompt = (
        ...
        "Mark SAFE for everything else — including all everyday objects (cups, mugs, phones, "
        "toys, books, food, clothing, furniture, vehicles), animals, nature, fantasy, "
        "adventure, people, and anything a child might normally encounter at home or school.\n\n"
