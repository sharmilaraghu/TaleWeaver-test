...
async def _is_safe_for_children(content: str) -> bool:
    ...
    prompt = (
        f"You are a strict content moderator for a children's story app for ages 4-10.\n"
        f"Evaluate this theme: \"{content}\"\n\n"
        "Reply with exactly one word: SAFE or UNSAFE.\n\n"
        "UNSAFE — mark UNSAFE if the theme includes ANY of the following:\n"
        "- Weapons of any kind: guns, pistols, rifles, firearms, shooting, knives, swords, daggers, "
        "blades, axes, bombs, explosives, missiles, or any item designed to harm\n"
        "- Violence, fighting, killing, blood, gore, or injury\n"
        "- Death, murder, suicide, or self-harm\n"
        "- Horror, demons, evil spirits, or genuinely frightening content\n"
